#!/usr/bin/env python3
"""
Translate Sunan an-Nasai iwh_id field to proper Bahasa Indonesia.
Processes files 001.json through 052.json (52 files, ~5,765 hadiths).
...
def main():
    ...
    print(f"Processing Sunan an-Nasai — 52 files\n")

    files = [f"{i:03d}.json" for i in range(1, 53)]
    total_translated = 0
    ...
    print(f"\nDone. Nasai hadiths translated: {total_translated}")
