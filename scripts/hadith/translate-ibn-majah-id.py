#!/usr/bin/env python3
"""
Translate Sunan Ibn Majah iwh_id field to proper Bahasa Indonesia.
Processes files 001.json through 038.json (38 files, ~4,343 hadiths).
...
DATA_DIR = "/Users/admin/Sites/ummeco/islamwiki/web/data/hadith/ibn-majah"
...
def main():
    ...
    print(f"Processing Sunan Ibn Majah — 38 files\n")

    files = [f"{i:03d}.json" for i in range(1, 39)]
    total_translated = 0
    ...
    print(f"\nDone. Ibn Majah hadiths translated: {total_translated}")
