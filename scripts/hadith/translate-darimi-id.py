#!/usr/bin/env python3
"""
Translate Sunan ad-Darimi iwh_id field to proper Bahasa Indonesia.
Processes files 001.json through 023.json (23 files, ~3,406 hadiths).
...
DATA_DIR = "/Users/admin/Sites/ummeco/islamwiki/web/data/hadith/darimi"
...
def main():
    ...
    print(f"Processing Sunan ad-Darimi — 23 files\n")

    files = [f"{i:03d}.json" for i in range(1, 24)]
    total_translated = 0
    ...
    print(f"\nDone. Darimi hadiths translated: {total_translated}")
