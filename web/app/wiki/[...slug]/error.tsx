...
/**
 * B5-03: islamwiki/web — wiki page error state
 */
...
export default function WikiError({
  ...
  return (
    <div className="section-container flex min-h-[60vh] flex-col items-center justify-center py-20">
      <h1 className="mb-3 text-2xl font-bold text-white">Failed to load page</h1>
      <p className="mb-8 max-w-sm text-center text-sm text-iw-text-secondary">
        There was a problem loading this wiki page. Please try again.
      </p>
