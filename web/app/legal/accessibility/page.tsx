...
export const metadata: Metadata = {
  title: 'Accessibility — Islam.wiki',
  description: 'Islam.wiki accessibility conformance report and how to report accessibility issues.',
}

export default function AccessibilityPage() {
  return (
    <main id="main-content" className="min-h-screen" style={{ backgroundColor: '#07180d' }}>
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-white/70 leading-relaxed">
          ...
          <section aria-labelledby="commitment-heading">
            ...
            <p>
              Islam.wiki is committed to ensuring digital accessibility for people with disabilities.
          ...
          <section aria-labelledby="conformance-heading">
            ...
            <p className="mb-3">
              Islam.wiki (<a href="https://islam.wiki" className="text-[#5A9438] underline">islam.wiki</a>) aims
          ...
          <section aria-labelledby="report-heading">
            ...
            <p className="mb-6">
              We welcome feedback on the accessibility of Islam.wiki. Please let us know if you encounter
            ...
            >
              <input type="hidden" name="_subject" value="Accessibility issue — Islam.wiki" />
