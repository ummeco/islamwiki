  ...
  return (
    <div className="section-container flex min-h-[60vh] flex-col items-center justify-center py-20">
      ...
      <p className="mb-8 max-w-md text-center text-iw-text-secondary">
        The historical event you requested was not found.
      </p>
      <Link href="/history" className="rounded-lg bg-iw-accent px-6 py-2.5 text-sm font-semibold text-iw-bg transition-colors hover:bg-iw-accent-light">
        Browse History
      </Link>
    </div>
  )
