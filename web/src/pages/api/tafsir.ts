// FILE:    src/pages/api/tafsir.ts
// PURPOSE: AI tafsir (Quranic commentary) streaming endpoint — Astro SSR port of app/api/tafsir/route.ts
// SECURITY: ANTHROPIC_API_KEY is server-only (never reaches client islands).
//   Theology gate enforced in the prompt: strictly mainstream Ahl us-Sunnah wal-Jama'ah.
//   Rate-limited 10 req / 15 min per IP (lib/rate-limit, preserved exactly).
// REF: ports app/api/tafsir/route.ts · Next→Astro migration (D-P2-STACK-CANON)
