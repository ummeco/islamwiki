/**
 * SettingsForm.tsx — Astro island port of app/account/settings/page.tsx
 *
 * PURPOSE: Client-only reading preferences (language, translation, reciter, tafsir).
 *   Persisted to localStorage; no account required (syncs across devices once signed in,
 *   per the original copy). Hydrated via client:load on /account/settings.
 *
 * CONVERSION (Next → Astro):
 *   - 'use client' page → island. next/link → <a>. RECITERS imported from the existing
 *     @/hooks/useAudioPlayer (client hook). No server data, no secrets.
 * REF: ports app/account/settings/page.tsx (auth-interactive migration group)
 */
'use client'
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-10">
      ...
      <div className="mb-8 flex items-center gap-3">
        <a href="/account" className="text-iw-text-muted transition-colors hover:text-white" aria-label="Back to account">
        ...
        {saved && <span className="ml-auto text-xs font-medium text-iw-accent">Saved</span>}
      </div>

      <div className="space-y-8">
        {/* Language */}
        <section>
          <h2 className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-iw-text-muted">Reading Language</h2>
        ...
        {/* Translation */}
        <section>
          <h2 className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-iw-text-muted">Default Translation</h2>
        ...
        {/* Reciter */}
        <section>
          <h2 className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-iw-text-muted">Default Quran Reciter</h2>
          <div className="space-y-1">
        ...
        {/* Tafsir */}
        <section>
          <h2 className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-iw-text-muted">Default Tafsir Source</h2>
          <div className="space-y-1">
      ...
      <p className="mt-10 text-center text-xs text-iw-text-muted">
        ...
        <a href="/account" className="text-iw-accent hover:underline">Sign in</a>{' '}
