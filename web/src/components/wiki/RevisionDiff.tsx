/**
 * RevisionDiff.tsx — Astro island port of components/wiki/revision-diff.tsx
 *
 * PURPOSE: Line-level diff view between two revisions.
 * CONVERSION: copied verbatim minus 'use client'. Uses the `diff` package.
 *   Diff content is rendered as React text nodes (auto-escaped) — never via
 *   dangerouslySetInnerHTML — so no sanitization is required here.
 * REF: ports components/wiki/revision-diff.tsx (articles-wiki migration group)
 */
