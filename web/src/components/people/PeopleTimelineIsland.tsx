/**
 * PeopleTimelineIsland.tsx — Astro island port of components/people/timeline.tsx.
 * Mechanical swap only: next/link <Link href ref> → native <a href ref> (next/link
 * forwards its ref onto the underlying anchor, so behavior is identical). All
 * horizontal-scroll timeline logic preserved verbatim.
 * REF: ports components/people/timeline.tsx · D-P2-STACK-CANON
 */
