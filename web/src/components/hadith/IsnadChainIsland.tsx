/**
 * IsnadChainIsland.tsx — Astro island port of components/hadith/isnad-chain.tsx
 *
 * PURPOSE: Vertical isnad (chain of narration) visualization with a collapsible
 *          Arabic chain-text toggle. Ported from the Next.js 'use client' component
 *          verbatim except next/link <Link> → plain <a> (narrator → /people/<slug>).
 *          All node/evaluation rendering and the useState toggle are unchanged.
 * INPUTS:  chain[], evaluation?, chainTextAr?
 * OUTPUTS: Isnad chain card with collapsible Arabic text
 * CONSTRAINTS: No next/* imports (Astro island).
 * REF: ports components/hadith/isnad-chain.tsx · D-P2-STACK-CANON
 */
'use client'
