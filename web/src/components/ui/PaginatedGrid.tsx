/**
 * PaginatedGrid.tsx — Astro island port of components/ui/paginated-grid.tsx
 *
 * PURPOSE: Generic searchable / tabbed / paginated grid used by listing islands.
 * CONVERSION: copied verbatim minus 'use client'. No next/* imports in original.
 * REF: ports components/ui/paginated-grid.tsx (articles-wiki migration group)
 */
